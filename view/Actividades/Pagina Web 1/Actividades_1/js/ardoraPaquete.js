...
function inicia(){
   ...
   menuLateral='';
   menuActividades='<h1>Actividades</h1><a href=\"javascript:irA(0)\" title=\"Sopa de Letras\">1 </a><a href=\"javascript:irA(1)\" title=\"Crucigrama\">2 </a><a href=\"javascript:irA(2)\" title=\"Ahorcado\">3 </a><a href=\"javascript:irA(3)\" title=\"Damero\">4 </a><a href=\"javascript:irA(4)\" title=\"Album\">5 </a></tr><tr><a href=\"javascript:irA(5)\" title=\"Panel Grafico\">6 </a>';
...
taboaContidos[0]=new act("Sopa de Letras","Sopa de Letras","","<object width='100%' height='600' type='text/html' data='SI/SI.htm'></object>",true,"http://fpg.hol.es/Seguridad-Informatica-I/",true,true,true);
taboaContidos[1]=new act("Crucigrama","Crucigrama","","<object width='100%' height='600' type='text/html' data='SI1/SI1.htm'></object>",true,"http://fpg.hol.es/Seguridad-Informatica-I/",true,true,true);
taboaContidos[2]=new act("Ahorcado","Ahorcado","","<object width='100%' height='600' type='text/html' data='SI2/SI2.htm'></object>",true,"http://fpg.hol.es/Seguridad-Informatica-I/",true,true,true);
taboaContidos[3]=new act("Damero","Damero","","<object width='100%' height='600' type='text/html' data='SI3/SI3.htm'></object>",true,"http://fpg.hol.es/Seguridad-Informatica-I/",true,true,true);
taboaContidos[4]=new act("Album","Album","","<object width='100%' height='600' type='text/html' data='SI4/SI4.htm'></object>",true,"http://fpg.hol.es/Seguridad-Informatica-I/",true,true,true);
taboaContidos[5]=new act("Panel Grafico","Panel Grafico","","<object width='100%' height='600' type='text/html' data='SI5/SI5.htm'></object>",true,"http://fpg.hol.es/Seguridad-Informatica-I/",true,true,true);
