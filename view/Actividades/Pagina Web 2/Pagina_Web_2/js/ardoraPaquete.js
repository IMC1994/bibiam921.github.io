...
function inicia(){
   ...
   menuLateral='';
   menuActividades='<h1>Actividades</h1><a href=\"javascript:irA(0)\" title=\"Pulze\">1 </a><a href=\"javascript:irA(1)\" title=\"Relacion - Palabra\">2 </a><a href=\"javascript:irA(2)\" title=\"Juego de Memoria\">3 </a><a href=\"javascript:irA(3)\" title=\"Completar Palabras\">4 </a><a href=\"javascript:irA(4)\" title=\"Completar Texto\">5 </a></tr><tr><a href=\"javascript:irA(5)\" title=\"Tablas\">6 </a>';
...
taboaContidos[0]=new act("Pulze","Pulze","","<object width='100%' height='600' type='text/html' data='SI6/SI6.htm'></object>",true,"http://fpg.hol.es/Seguridad-Informatica-I/",true,true,true);
taboaContidos[1]=new act("Relacion - Palabra","Relacion - Palabra","","<object width='100%' height='600' type='text/html' data='SI7/SI7.htm'></object>",true,"http://es.ccm.net/contents/622-introduccion-a-la-seguridad-informatica",true,true,true);
taboaContidos[2]=new act("Juego de Memoria","Juego de Memoria","","<object width='100%' height='600' type='text/html' data='SI8/SI8.htm'></object>",true,"http://fpg.hol.es/Seguridad-Informatica-I/",true,true,true);
taboaContidos[3]=new act("Completar Palabras","Completar Palabras","","<object width='100%' height='600' type='text/html' data='SI9/SI9.htm'></object>",true,"http://es.ccm.net/contents/622-introduccion-a-la-seguridad-informatica",true,true,true);
taboaContidos[4]=new act("Completar Texto","Completar Texto","","<object width='100%' height='600' type='text/html' data='SI10/SI10.htm'></object>",true,"http://fpg.hol.es/Seguridad-Informatica-I/",true,true,true);
taboaContidos[5]=new act("Tablas","Tablas","","<object width='100%' height='600' type='text/html' data='SI11/SI11.htm'></object>",true,"http://es.ccm.net/contents/622-introduccion-a-la-seguridad-informatica",true,true,true);
