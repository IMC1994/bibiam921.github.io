...
taboaContidos[0]=new act("Ordenar","Ordenar","","<object width='100%' height='420' type='text/html' data='SI12/SI12.htm'></object>",true,"http://fpg.hol.es/Seguridad-Informatica-I/",true,true,true);
taboaContidos[1]=new act("Ordenar Parrafos","Ordenar Parrafos","","<object width='100%' height='420' type='text/html' data='SI13/SI13.htm'></object>",true,"http://es.ccm.net/contents/622-introduccion-a-la-seguridad-informatica",true,true,true);
taboaContidos[2]=new act("Seleccionar","Seleccionar","","<object width='100%' height='420' type='text/html' data='SI14/SI14.htm'></object>",true,"http://fpg.hol.es/Seguridad-Informatica-I/",true,true,true);
taboaContidos[3]=new act("Test","Test","","<object width='100%' height='420' type='text/html' data='SI15/SI15.htm'></object>",true,"http://es.ccm.net/contents/622-introduccion-a-la-seguridad-informatica",true,true,true);
taboaContidos[4]=new act("Sopa de Letras","Sopa de Letras","","<object width='100%' height='420' type='text/html' data='SI16/SI16.htm'></object>",true,"http://fpg.hol.es/Seguridad-Informatica-I/",true,true,true);
taboaContidos[5]=new act("Ahorcado","Ahorcado","","<object width='100%' height='420' type='text/html' data='SI17/SI17.htm'></object>",true,"http://es.ccm.net/contents/622-introduccion-a-la-seguridad-informatica",true,true,true);
